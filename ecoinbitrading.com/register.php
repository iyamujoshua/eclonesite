    ...
    <div class="area">
        <div class="bodycontainer">
            ...
            <div style="margin: 20px 0;">
                <a href="index-3.html">HOME</a> / CREATE AN ACCOUNT
            </div>
        </div>
...
<div class="smallcontainer padding">
    <form action="#" method="post" class="validate row" id="register">
        ...
        <div class="col-12 col-m-12 col-sm-12">
            <input type="text" placeholder="Reference ID(Optional)" name="ref_id" style="width:100%" style="width:100%" class="round">
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="text" placeholder="FullName" required name="name" required style="width:100%" class="round">
            <div id="fnameErr" class="form_hint"> First name must not be empty!</div>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="email" placeholder="Email" required name="email" style="width:100%" class="round">
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="tel" id="mobile-number" required name="phone" class="round" style="width:100%;">
            <select id="address-country" name="phone" style="display:none" required></select>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="text" placeholder="Address" required name="address" style="width:100%" class="round">
            <div id="addressErr" class="form_hint"> Address must not be empty!</div>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="text" placeholder="Username" required name="username" style="width:100%" class="round">
            <div id="addressErr" class="form_hint"> Username</div>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            ...
            <div id="passwordErr" class="form_hint"> Make your password stronger with more letters and at least a
                numbers</div>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="password" placeholder="Confirm Password" required name="password2" style="width:100%" class="round" oninput="passwordca(this)">
        </div>
        <div class="col-12 col-m-12 col-sm-12"><input type="checkbox" name="age" required> I am 18 years of age or older
        </div>
        <div class="col-12 col-m-12 col-sm-12"><input type="checkbox" name="agree" required checked> I agree to BestBit
            Crypto || Your Trusted Bitcoin Exchange and Investment Company <a href="info/terms.html" target="_blank">Terms and conditions</a>
        </div>
        <div class="col-12 col-m-12 col-sm-12"><input type="checkbox" name="mail" required> I agree to receive BestBit
            Crypto || Your Trusted Bitcoin Exchange and Investment Company and third party emails</label>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
            <input type="submit" name="submit" value="Submit" class="btn round default" style="border:0"><br><br>
